...
dev\Lib - static libraries for libwebp that can be included in your programs.
...
to a WebP file using a quality factor of 80 on a 0->100 scale (0 being the
...
The sample decoding program dwebp.exe will take
a .webp file and decode it to a PNG image file (amongst other formats).
This is simply to demonstrate the use of the API. You can verify the
file test.webp decodes to exactly the same as test_ref.ppm by using:

 dwebp.exe test.webp -ppm -o test.ppm
...
package contains a precompiled static library in release and debug builds.
It has been compiled with Visual Studio 2008 with static runtime library.
